...
public:
	...
	void mill() override {
		if (this->ledgeSides[0] && this->ledgeSides[2]) {
			...
			else std::cout << "Фрезерование вертикальными линиями с левого верхнего угла" << std::endl;
		}
		else {
			if (this->ledgeSides[3]) std::cout << "Фрезерование змейкой с правого нижнего угла" << std::endl;
			else std::cout << "Фрезерование вертикальными линиями с левого нижнего угла" << std::endl;
		}
	}
};
